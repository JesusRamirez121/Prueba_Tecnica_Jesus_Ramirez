# ══════════════════════════════════════════════════════════════════════
# TAREA SCREENPLAY: ActualizarUsuario
# ══════════════════════════════════════════════════════════════════════
# Encapsula la interacción PUT /user/{username}
# Actualiza únicamente firstName y email del usuario.
#
# Variables heredadas del contexto del llamador:
#   baseUrl, username, userId, updatedFirstName,
#   updatedLastName, updatedEmail, password, phone
#
